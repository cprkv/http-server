 ...
 */
void ulid_generate_str(struct ulid_generator*, char[27]);

/* Generate a new ULID.
 */
void ulid_generate(struct ulid_generator*, unsigned char[16]);
 ...
 */
int ulid_decode(unsigned char ulid[16], const char* str);
